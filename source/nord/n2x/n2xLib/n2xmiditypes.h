...
namespace n2x
{
	enum SysexByte : uint8_t
	{
		...
		EmuSetPartCC = 92,
		EmuSetMultiParam = 93,		// f0, IdClavia, IdDevice, IdN2x, EmuSetMultiParam, paramHi, paramLo, part, value, f7
	};
	...
	static constexpr uint32_t g_nameLength = 20;	// Extended Aura editor format: 20 ASCII bytes for the name
	static constexpr uint32_t g_legacyNameLength = 10;	// Original Aura editor format: 10 bytes

	static constexpr uint32_t g_singleDumpSize = g_singleDataSize + g_sysexContainerSize;
	static constexpr uint32_t g_singleDumpWithLegacyNameSize = g_singleDumpSize + g_legacyNameLength;
	...
	static constexpr uint32_t g_multiDumpWithLegacyNameSize = g_multiDumpSize + g_legacyNameLength;
