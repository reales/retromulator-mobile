...
datetime ptdecl now(bool utc)
{
    ...
    timeval tv;
    gettimeofday(&tv, nil);
    int edays = (int)(tv.tv_sec / 86400  // days since Unix "Epoch", i.e. 01/01/1970
        + 719162);                  // plus days between 01/01/0001 and Unix Epoch
    int esecs = (int)(tv.tv_sec % 86400); // the remainder, i.e. seconds since midnight
