...
namespace dsp56k
{
	...
	public:
		...
		// On iOS the sandbox forbids shm_open. Call this before creating any
		// device to provide a writable directory for temp file-backed mmap.
		static void setTempPath(const std::string& _path) { g_tempPath = _path; }
