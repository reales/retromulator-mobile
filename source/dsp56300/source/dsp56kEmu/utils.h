...
//#endif
	...
	[[maybe_unused]] static int bittest( const TReg56& _val, unsigned int _bitNumber )
	{
		return bittest( _val.var, _bitNumber );
	}

	[[maybe_unused]] static int bittest( const TReg48& _val, unsigned int _bitNumber )
	{
		return bittest( _val.var, _bitNumber );
	}

	[[maybe_unused]] static int bittest( const TReg24& _val, unsigned int _bitNumber )
	{
		return bittest( _val.var, _bitNumber );
	}

	[[maybe_unused]] static int bittest( const TReg8& _val, unsigned int _bitNumber )
	{
		return bittest( _val.var, _bitNumber );
	}
	...
	[[maybe_unused]] static int bittestandchange( TReg24& _val, unsigned int _bitNumber )
	{
	...
	[[maybe_unused]] static TUInt8 bitreverse8( TUInt8 a )
	{
		return	(a & 0x80 >> 7)
			|	(a & 0x40 >> 5)
			|	(a & 0x20 >> 3)
	...
	[[maybe_unused]] static TWord delta(TWord b, TWord a)
	{
		auto d = b - a;
