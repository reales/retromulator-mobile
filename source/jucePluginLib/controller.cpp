...
namespace pluginLib
{
		...
		, m_parameterLinks(*this)
	{
		...
		{
			// No UI available in headless build - log to stderr instead
			fprintf(stderr, "[Synthmulator] Warning: Failed to parse parameter descriptions: %s\n",
				m_descriptions.getErrors().c_str());
		}
	}
