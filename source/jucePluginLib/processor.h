...
namespace pluginLib
{
	...
	public:
		...
		// Returns the number of audio callback underruns and resets the counter.
		uint32_t getAndResetUnderrunCount() { return m_audioUnderrunCount.exchange(0, std::memory_order_relaxed); }
