...
#include "../include/player/tables.h"

#include "../include/midi.h" /* midi_event_length */
#include "../include/util.h" /* for clamp/min */
#include "../include/mem.h"
#include "../include/bits.h" /* [l/r]shift_signed */
...
void csf_midi_out_note(song_t *csf, int chan, const song_note_t *starting_note)
{
	...
	if (!csf || !(csf->flags & SONG_INSTRUMENTMODE))
		return;
