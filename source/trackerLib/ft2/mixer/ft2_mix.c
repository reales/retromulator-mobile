...
static void mix8bNoLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int8_t *base, *smpPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
	int32_t position;
...
static void mix8bLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int8_t *base, *smpPtr;
	int8_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
	...
	while (samplesLeft > 0)
	{
		...
		if (v->hasLooped)
		{
			for (i = 0; i < samplesToMix; i++)
			{
				RENDER_8BIT_SMP_S256INTRP_TAP_FIX
				INC_POS
			}
		}
		else
...
static void mix8bPingpongLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int8_t *base, *revBase, *smpPtr;
	int8_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
...
static void mix8bRampNoLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int8_t *base, *smpPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
	int32_t position;
...
static void mix8bRampLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int8_t *base, *smpPtr;
	int8_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
...
static void mix8bRampPingpongLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int8_t *base, *revBase, *smpPtr;
	int8_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
...
static void mix16bNoLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int16_t *base, *smpPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
	int32_t position;
...
static void mix16bLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int16_t *base, *smpPtr;
	int16_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
	...
	while (samplesLeft > 0)
	{
		...
		if (v->hasLooped)
		{
			for (i = 0; i < samplesToMix; i++)
			{
				RENDER_16BIT_SMP_S256INTRP_TAP_FIX
				INC_POS
			}
		}
		else
...
static void mix16bPingpongLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int16_t *base, *revBase, *smpPtr;
	int16_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
...
static void mix16bRampNoLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int16_t *base, *smpPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
	int32_t position;
...
static void mix16bRampLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int16_t *base, *smpPtr;
	int16_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
...
static void mix16bRampPingpongLoopS256Intrp(voice_t *v, uint32_t bufferPos, uint32_t numSamples)
{
	const int16_t *base, *revBase, *smpPtr;
	int16_t *smpTapPtr;
	float fSample, *fMixBufferL, *fMixBufferR;
...
const mixFunc mixFuncTab[] =
{
	...
	(mixFunc)mix8bNoLoopS256Intrp,
	(mixFunc)mix8bLoopS256Intrp,
	(mixFunc)mix8bPingpongLoopS256Intrp,
	...
	(mixFunc)mix16bNoLoopS256Intrp,
	(mixFunc)mix16bLoopS256Intrp,
	(mixFunc)mix16bPingpongLoopS256Intrp,
	...
	(mixFunc)mix8bRampNoLoopS256Intrp,
	(mixFunc)mix8bRampLoopS256Intrp,
	(mixFunc)mix8bRampPingpongLoopS256Intrp,
	...
	(mixFunc)mix16bRampNoLoopS256Intrp,
	(mixFunc)mix16bRampLoopS256Intrp,
	(mixFunc)mix16bRampPingpongLoopS256Intrp
};
